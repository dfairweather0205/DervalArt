                ...
                onclick: function () {
                    ...
                    if (jQuery('#cocobasic_shortcodes_popup_holder').is(":visible")) {
                        ...
                        jQuery('#cocobasic_shortcodes_popup_holder').load(url + '/cocobasic_shortcodes_popup.html#cocobasic_shortcodes_popup', function () {
                            ...
                            jQuery("#cocobasic_social").on('click', function () {
                                var shortcode = '[social href="#"]TW.[/social][social href="#"]FB.[/social][social href="#"]IN.[/social][social href="#"]BE.[/social]';
                                tinyMCE.activeEditor.execCommand('mceInsertContent', 0, shortcode);
                                jQuery("#cocobasic_shortcodes_popup_holder").hide();
                            });                         

                            jQuery("#cocobasic_big_text").on('click', function () {
                                var shortcode = '[big_text up="HELLO"]Rob Stone[/big_text]';
                                tinyMCE.activeEditor.execCommand('mceInsertContent', 0, shortcode);
                                jQuery("#cocobasic_shortcodes_popup_holder").hide();
                            });
                            
                               jQuery("#cocobasic_med_text").on('click', function () {
                                var shortcode = '[med_text]Bearable only through love hydrogen atoms[/med_text]';
                                tinyMCE.activeEditor.execCommand('mceInsertContent', 0, shortcode);
                                jQuery("#cocobasic_shortcodes_popup_holder").hide();
                            });
